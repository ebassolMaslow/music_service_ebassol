...
<head>
    ...
    <title>playlists-musician</title>
...
<body>
    ...
    <div class="menu-playlist">
        <div class="container">
            <div class="divs-menu-playlist">
                ...
                <div class="div-playlist-menu-playlist">
                    <a href="./playlists.php" class="albums-playlist-playlist menu-playlist-text">Плейлисты</a>
                </div>
                <div class="div-musicans-menu-playlist active-color-green">
    ...
    <!-- блок с любимыми музыкантами -->

    <div class="playlist-musicans">
        <div class="container">
            <div class="albums-fisrt-section">
                <div class="div-favorite">
                    <div class="lida_musician">
                ...
                <div class="div-favorite">
                    ...
                    <p class="albums-playlists-text-title text-center">nonno</p>
                    <p class="albums-playlists-text-subtitle text-center">Шансон</p>
                </div>
                <div class="div-favorite">
                    <div class="SasakaBone_musician">
                        <div class="releases-ddt-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                    ...
                    <p class="albums-playlists-text-title text-center">SasakaBone</p>
                    <p class="albums-playlists-text-subtitle text-center">Шансон</p>
                </div>
            </div>
            <div class="albums-fisrt-section">
                <div class="div-favorite">
                    <div class="pinkpagejpeg666_musician">
                        <div class="releases-ddt-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                    ...
                    <p class="albums-playlists-text-title text-center">pinkpagejpeg666</p>
                    <p class="albums-playlists-text-subtitle text-center">Шансон</p>
                </div>
            </div>
        </div>
