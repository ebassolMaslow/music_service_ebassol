...
<head>
    ...
    <title>Добавление в альбом - Редактирование</title>
...
echo "<form class=\"table_add\" action=\"./edit_adding_in_album-handler.php?idA=$ADT\" method=\"post\">";

$qInfoPlaylists = "SELECT * FROM adding_in_album WHERE ID_adding_in_album='$ADT'";
            ...
            <div class="form-content">
                <div class="div-ebassol-and-close">
                    ...
                    <div class="div-close-img div-close-btn-reg">
                        <a href="./adding_in_album-panel.php" class="close-img"><img src="./images/svg/close-button.svg" alt="close"></a>
                    </div>
                </div>
                    <div class="table_add_row">
                        <div class="div-input_form-email">
                            <?php
                            $qInfoADT = "SELECT * FROM albums";
                            addslashes($qInfoADT);
                            $resInfoADT = mysqli_query($connect, $qInfoADT) or die(mysqli_error($connect));
                            echo "<select class=\"select-track\" name=\"albums\">";
                            while ($InfoADT = mysqli_fetch_object($resInfoADT)) {
                                echo "<option name=\"" . $InfoADT->ID_albums . "\" value=\"" . $InfoADT->ID_albums . "\">" . $InfoADT->album_name . "</option>";
                            }
                            echo "</select>";
                            ?>
                        </div>
