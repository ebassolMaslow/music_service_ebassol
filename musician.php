...
<head>
    ...
    <title>Наши лучшие исполнители</title>
...
<body>
    ...
    <header>
        <div class="container">
            <ul class="main-menu">
                ...
                <li class="main-menu_item"><a href="./musician.php" class="menu-item page_press">Исполнители</a></li>
    ...
    <!-- блок с первым музыкантом -->

    <div class="musician">
        <div class="container">
            <h1 class="main_heading list-of-genres-heading">Исполнители</h1>
            <div class="musician-body">
                <a class="musiician-body-img"><img src="./images/musician1.png" alt="musiician" class="musiician"></a>
                <p class="musician-text">Повседневная практика показывает, что начало повседневной работы по
                    формированию позиции влечет за собой процесс внедрения и модернизации новых предложений. С другой
                    стороны сложившаяся структура организации в значительной степени обуславливает создание форм
                    развития. Разнообразный и богатый опыт реализация намеченных плановых заданий требуют определения и
                    уточнения существенных финансовых и административных условий. </p>
            </div>
            <div class="selections-of-performers">
                <div class="div-favorite">
                    <div class="favorite">
                        <div class="favorite-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#454340" />
                            </svg>
                            <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M35.5 20H20.5V35H15.5V20H0.5V15H15.5V0H20.5V15H35.5V20Z" fill="#454340" />
                            </svg>
                        </div>
                    </div>
                    <p class="favorite-text">Подборки</p>
                </div>
                <div class="div-div-albums">
                    ...
                    <p class="favorite-text">Новые треки</p>
                </div>
    ...
    <!-- блок с вторым музыкантом -->

    <div class="musician">
        <div class="container">
            <div class="musician-body">
                <a class="musiician-body-img"><img src="./images/musician2.png" alt="musiician" class="musiician"></a>
                <p class="musician-text">Значимость этих проблем настолько очевидна, что консультация с широким активом
                    играет важную роль в формировании новых предложений. С другой стороны реализация намеченных плановых
                    заданий влечет за собой процесс внедрения и модернизации модели развития. Таким образом начало
                    повседневной работы по формированию позиции позволяет выполнять важные задания по разработке
                    позиций, занимаемых участниками в отношении поставленных задач.предложений. </p>
            </div>
            <div class="selections-of-performers">
                <div class="div-favorite">
                    <div class="favorite">
    ...
    <!-- блок с третьим музыкантом -->

    <div class="musician">
        <div class="container">
            <div class="musician-body">
                <a class="musiician-body-img"><img src="./images/musician3.png" alt="musiician" class="musiician"></a>
                <p class="musician-text">Разнообразный и богатый опыт сложившаяся структура организации обеспечивает
                    широкому кругу (специалистов) участие в формировании системы обучения кадров, соответствует насущным
                    потребностям. Равным образом новая модель организационной деятельности требуют от нас анализа
                    направлений прогрессивного развития. Не следует, однако забывать, что укрепление и развитие
                    структуры влечет за собой процесс внедрения и модернизации направлений прогрессивного развития. </p>
            </div>
            <div class="selections-of-performers">
                <div class="div-favorite">
                    <div class="favorite">
