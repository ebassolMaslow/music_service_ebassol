        ...
        <div class="container">
            <div class="photo-and-button">
                ...
                <div class="button-and-text">
                    ...
                    <div class="mix-btn">
                        <a class="mix-btn-image"><img src="./images/svg/play_purple.svg" alt="play_purple"
                                class="mix-btn-img"></a>
                        <a class="mix-btn-text">Слушать</a>
                    </div>
                </div>
                <div class="upload-music-btn">
                    <button class="upload-btn">Загрузить трек</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="div-search">
                ...
                <div class="search-text">
                    <p class="search-track-text">Поиск трека</p>
                </div>
            </div>
        </div>
    </div>

    <!-- блок c песнями пользователя -->

    <div class="div-tracks">
        <div class="container">
            <div class="tracks">
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_1.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    ...
                    <div class="track-time">
                        <p class="track-time-text">4:20</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_2.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Где моя нога</p>
                        <p class="musician-name">СЕРЕГА ПИРАТ</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:18</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_3.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Sigma</p>
                        <p class="musician-name">Буерак</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:39</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_4.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Это не любовь</p>
                        <p class="musician-name">Кино</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">3:28</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_5.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Пустая голова</p>
                        <p class="musician-name">Комсомольск</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:37</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_6.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Scape</p>
                        <p class="musician-name">DVRST</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:20</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_7.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Романс</p>
                        <p class="musician-name">Диктофон</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">3:25</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_8.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Саша Белый</p>
                        <p class="musician-name">DEAD BLONDE</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:55</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_9.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Гуси</p>
                        <p class="musician-name">Рычаги машин</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">2:46</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_10.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Че Гевара</p>
                        <p class="musician-name">Uma2rman</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">4:26</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_11.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Череповец</p>
                        <p class="musician-name">Кровосток</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div class="track-time">
                        <p class="track-time-text">4:27</p>
                    </div>
                </div>
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_12.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">Kiss me</p>
                        <p class="musician-name">Vampyx</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="div-track">
                    <div class="track-img">
                        <a class="track_link"><img src="./images/playlist_13.png" alt="обложка трека"
                                class="track-cover"></a>
                    </div>
                    <div class="track-body">
                        <p class="track-name">псы попадут в рай</p>
                        <p class="musician-name">ПОЛМАТЕРИ</p>
                    </div>
                    <div class="track-status">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="player-items">
                ...
                <div class="icons-player">
                    <svg class="plus_white_player" width="25" height="25" viewBox="0 0 25 25" fill="none"
                        ...
                        <path d="M25 14.2857H14.2857V25H10.7143V14.2857H0V10.7143H10.7143V0H14.2857V10.7143H25V14.2857Z"
                            fill="#F0F0F0" />
                    </svg>
