...
<head>
    ...
    <title>Плейлист Редактирование</title>
...
echo "<form class=\"table_add\" action=\"./edit_playlists_handler.php?idA=$playlist\" method=\"post\">";

$qInfoPlaylists = "SELECT * FROM playlists WHERE ID_playlists='$playlist'";
                ...
                <form class="table_add" action="./edit_playlists_handler.php" method="post">
                    <div class="table_add_row">
                        <div class="div-input_form-login">
                            <input type="text" class="input_form-email" name="playlist_name" placeholder="Имя плейлиста" value="<?php echo "" . $InfoPlaylists->playlist_name . ""; ?>">
                        </div>
                        <div class="div-input_form-login">
                            <input type="text" class="input_form-email" name="playlist_photo" placeholder="Фото плейлиста" value="<?php echo "" . $InfoPlaylists->playlist_photo . ""; ?>">
                        </div>
