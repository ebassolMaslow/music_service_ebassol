...
echo "<form class=\"table_add\" action=\"./edit_genre_handler.php?idA=$playlist\" method=\"post\">";

$qInfoPlaylists = "SELECT * FROM genre WHERE ID_genre='$playlist'";
            ...
            <div class="form-content">
                <div class="div-ebassol-and-close">
                    ...
                    <div class="div-close-img div-close-btn-reg">
                        <a href="./genre-panel.php" class="close-img"><img src="./images/svg/close-button.svg" alt="close"></a>
                    </div>
                </div>
                <form class="table_add" action="./edit_genre_handler.php" method="post">
                    <div class="table_add_row">
                        <div class="div-input_form-login">
                            <input type="text" class="input_form-email" name="genre" placeholder="Имя плейлиста" value="<?php echo "" . $InfoPlaylists->genre . ""; ?>">
                        </div>
                    </div>
            </div>
