...
<body>
    ...
    <div class="playlist-and-albums">
        <div class="container">
            <div class="photo-and-button">
                <div class="div-photo">
                    <a class="photo"><img src="./images/Maslikov_profile_purple.png" alt="Maslikov_profile_purple" class="Maslikov_profile_purple"></a>
                </div>
                <div class="button-and-text">
                    <p class="playlists-title">Плейлисты</p>
                    <p class="nickname-subtitle">bozhehraniebassol</p>
                    <div class="mix-btn">
                        <a class="mix-btn-image"><img src="./images/svg/mix_purple.svg" alt="mix-btn-img" class="mix-btn-img"></a>
    ...
    <div class="menu-playlist">
        <div class="container">
            <div class="divs-menu-playlist">
                <div class="div-albums-menu-playlist active-color-green">
    ...
    <!-- блок с добавленными альбомами других исполнителей -->

    <div class="div-albums-playlists">
        <div class="container">
            <div class="albums-fisrt-section">
                <div class="div-favorite">
                    <div class="KaC_playlist">
                ...
                <div class="div-favorite">
                    ...
                    <p class="albums-playlists-text-title">Шоу-бизнес</p>
                    <p class="albums-playlists-text-subtitle">Буерак</p>
                    <p class="albums-playlists-text-subtitle">2019</p>
                </div>
                <div class="div-favorite">
                    <div class="boulevard_depo_playlist">
                        <div class="releases-ddt-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                            </svg>
                    ...
                    <p class="albums-playlists-text-title">old blood</p>
                    <p class="albums-playlists-text-subtitle">boulevard depo</p>
                    <p class="albums-playlists-text-subtitle">2020</p>
                </div>
            </div>
            <div class="albums-fisrt-section">
                <div class="div-favorite">
                    <div class="operatsiya_plastilin_playlist">
                        <div class="releases-ddt-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                            </svg>
                    ...
                    <p class="albums-playlists-text-title">Рейв</p>
                    <p class="albums-playlists-text-subtitle">Операция пластилин</p>
                    <p class="albums-playlists-text-subtitle">2019</p>
                </div>
                <div class="div-favorite">
                    <div class="zveri_playlist">
                        <div class="releases-ddt-billet">
                            <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                            </svg>
                    ...
                    <p class="albums-playlists-text-title">Районы кварт...</p>
                    <p class="albums-playlists-text-subtitle">Звери</p>
                    <p class="albums-playlists-text-subtitle">2004</p>
                </div>
            </div>
        </div>
    </div>
