...
<head>
    ...
    <title>Панель администратора - Любимое</title>
...
<body>
    ...
    <header>
        <div class="admin-container">
            <ul class="main-menu-panel">
                ...
                <li class="main-menu-panel_item"><a href="./favorite-panel.php" class="menu-item-panel admin-menu-pressed">Любимое</a></li>
    ...
    <div class="div-title-admin">
        <div class="admin-container">
            <div class="add-btn-divs">
                <div class="div-title-admin">
                    <h1 class="title-admin">Любимое</h1>
                </div>
                <div class="btn_add">
                    <a href="./create_favorite.php">Добавить запись</a>
                </div>
            </div>
        </div>
    </div>
    ...
    if (isset($_GET['ID_favorite'])) {
        $favoriteD = $_GET['ID_favorite'];
        $qDeletefavorite = "DELETE FROM `favorite` WHERE ID_favorite='$favoriteD'";
        addslashes($qDeletefavorite);
        $resDeleteqDeletefavorite = mysqli_query($connect, $qDeletefavorite) or die(mysqli_error($connect));
    }

    $qInfoFavorite = "SELECT * FROM favorite, users WHERE favorite.ID_users = users.ID_Users";
        ...
        <div class=\"admin-container\">
            <div class=\"admin_table_row\">
                <div class=\"admin_table_cell_first admin_projects_table_id\">
                    <p>$InfoFavorite->ID_favorite</p>
                </div>
                <div class=\"admin_table_cell admin_projects_table_name\">
                    <p class=\"admin_table_cell-text margin-admin-user-table\">$InfoFavorite->favorite_photo</p>
                </div>
                <div class=\"admin_table_cell admin_projects_table_name\">
                    <p class=\"admin_table_cell-text margin-admin-user-table\">$InfoFavorite->login</p>
                </div>
                <div class=\"admin_projects_table_act\">
                    <a href=\"edit_favorite.php?idA=$InfoFavorite->ID_favorite\"><img class=\"admin_table_act_image\" src=\"./images/svg/edit_green.svg\"></a>
                <a href=\"?ID_favorite=$InfoFavorite->ID_favorite\"><img class=\"admin_table_act_image\" src=\"./images/svg/delete_green.svg\"></a>
            </div>
        </div>
    </div>
";
