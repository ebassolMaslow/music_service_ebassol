...
<head>
    ...
    <title>Пользователь добавление</title>
    ...
    <div class="track_create">
        <div class="wrapper-container">
            <div class="form-content">
                ...
                <form class="table_add" action="./create_user_handler.php" method="post">
                    <div class="table_add_row">
                        <div class="div-input_form-login">
                            <input type="text" class="input_form-email" name="login" placeholder="Логин" minlength="4" required>
                        </div>
                        <div class="div-input_form-login">
                            <input type="email" class="input_form-email" name="email" placeholder="Почта" required>
                        </div>
                        <div class="div-input_form-password">
                            <input type="text" class="input_form-email" name="password" placeholder="Пароль" minlength="8" required>
                        </div>
                    </div>
