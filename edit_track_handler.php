...
$queryTrack = "UPDATE `track` SET `track_name` = '$trackname', `ID_musician` = '$IDmusician', `Number_of_auditions` = '$Numberofauditions', `year_of_release` = '$yearofrelease', `ID_genre` = '$IDgenre' WHERE `ID_track` = '$track'";
