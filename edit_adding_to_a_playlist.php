...
echo "<form class=\"table_add\" action=\"./edit_adding_to_a_playlist-handler.php?idA=$ADT\" method=\"post\">";

$qInfoPlaylists = "SELECT * FROM adding_to_a_playlist WHERE ID_adding_to_a_playlist='$ADT'";
