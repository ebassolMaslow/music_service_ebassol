...
<body>
    ...
    <header>
        <div class="container">
            <ul class="main-menu">
                ...
                <li class="main-menu_item"><a href="./genres.php" class="menu-item page_press">Жанры</a></li>
    ...
    <!-- блок со списком жанров -->

    <div class="list-of-genres">
        <div class="container">
            <h1 class="main_heading list-of-genres-heading">Жанры</h1>
            <div class="div-list-of-genres">
                <ul>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Поп</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Рок</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Реп</a></li>
                </ul>
                <ul>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Фонк</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Техно</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Танцевальная</a></li>
                </ul>
                <ul>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Шансон</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Гиперпоп</a></li>
                    <li class="list-of-genres-li"><a href="#" class="list-of-genres-item">Классика</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="div-pop">
        <div class="container">
            <p class="pop-text">Поп</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                ...
                <div class="div-favorite">
                    ...
                    <p class="favorite-text">Топ 100</p>
                </div>
                <div class="div-favorite">
                    <div class="new-pop">
                        <div class="releases-ddt-billet">
                    ...
                    <p class="favorite-text">Новинки</p>
                </div>
            </div>

            <!-- блок с жанром рок -->

            <p class="pop-text">Рок</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                        <div class="playlist-billet">
            ...
            <!-- блок с жанром танцевальная -->

            <p class="pop-text">Танцевальная</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                        <div class="playlist-billet">
            ...
            <!-- блок с жанром Шансон -->

            <p class="pop-text">Шансон</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                        <div class="playlist-billet">
            ...
            <!-- блок с жанром Гиперпоп -->

            <p class="pop-text">Гиперпоп</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                        <div class="playlist-billet">
            ...
            <!-- блок с жанром Классика -->

            <p class="pop-text">Классика</p>
            <div class="compilations-pop">
                <div class="div-playlist div-favorite">
                    <div class="playlist">
                        <div class="playlist-billet">
