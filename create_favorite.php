...
<head>
    ...
    <title>Любимое добавление</title>
    ...
    <div class="track_create">
        <div class="wrapper-container">
            <div class="form-content">
                ...
                <form class="table_add" action="./create_favorite_handler.php" method="post">
                    <div class="table_add_row">
                        <div class="div-input_form-login">
                            <input type="text" class="input_form-email" name="favorite_photo" placeholder="Фото любимое" required>
                        </div>
