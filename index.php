...
<body>
    ...
    <header>
        <div class="container">
            <ul class="main-menu">
                ...
                <li class="main-menu_item"><a href="./index.php" class="menu-item page_press">Главная</a></li>
                ...
                <p class="fio_user"><?php echo "".$InfoTrack->login."";?></p>
                <?php
                if (isset($roles)) {
    ...
    <div class="recommendation_block">
        <div class="container">
            <h1 class="main_heading">Главная</h1>
            <p class="main_subtitle">Рекомендации</p>
            <div class="hero-blocks">
                <div class="listen-blocks">
                    <div class="block-for-you">
                        <div class="div-for-you">
                            <a href="" class="listen-svg">
                                <svg width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path class="svg-hover-purple" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                </svg>
                            </a>
                            <a href="" class="listen-text">Слушать</a>
                        </div>
                        <p class="subtitle-for-you">Для вас</p>
                    </div>
                    <div class="block-albums">
                        <div class="div-albums">
                            <a href="" class="listen-svg">
                                <svg width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path class="svg-hover-purple" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                </svg>
                        ...
                        <p class="subtitle-for-you">Альбомы</p>
                    </div>
                </div>
                <div class="recommendations">
                    <a href="" class="recommendation-svg">
                        <svg width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path class="svg-hover-purple" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                        </svg>
                    </a>
                    <a href="" class="recommendation-text">Рекомендации</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="playlists-block">
        <div class="container">
            <div class="div-title-playlist-main">
                <p class="playlist-title">Ваши плейлисты</p>
            </div>
            <div class="block-of-playlist">
                <svg class="prev_button button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M20.5625 3.0625L8.3125 15.3125H35V19.6875H8.3125L20.5625 31.9375L17.5 35L0 17.5L17.5 0L20.5625 3.0625Z" fill="#F0F0F0" />
                </svg>
                <div class="slider-playlists">
                    <div class="slider-playlists-line">
                        <div class="div-favorite">
                            <div class="favorite">
                                <div class="favorite-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-white" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#454340" />
                                    </svg>
                                    <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-white" d="M35.5 20H20.5V35H15.5V20H0.5V15H15.5V0H20.5V15H35.5V20Z" fill="#454340" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="div-div-albums">
                            ...
                            <p class="favorite-text">Альбомы</p>
                        </div>
                        <div class="div-playlist">
                            <div class="playlist">
                                <div class="playlist-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-white" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#454340" />
                                    </svg>
                                    <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="favorite-text">Плейлисты</p>
                        </div>
                        <div class="div-playlist slider-margin">
                            <div class="playlist">
                                <div class="playlist-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-white" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#454340" />
                ...
                <svg class="next_button button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M14.4375 3.0625L26.6875 15.3125H0V19.6875H26.6875L14.4375 31.9375L17.5 35L35 17.5L17.5 0L14.4375 3.0625Z" fill="#F0F0F0" />
                </svg>
            </div>
        </div>
    </div>
    ...
    <div class="releases">
        <div class="container">
            <div class="div-title-playlist-main">
                <p class="playlist-title">Релизы</p>
            </div>
            <div class="block-of-playlist">
                <svg class="prev_button-releases button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M20.5625 3.0625L8.3125 15.3125H35V19.6875H8.3125L20.5625 31.9375L17.5 35L0 17.5L17.5 0L20.5625 3.0625Z" fill="#F0F0F0" />
                </svg>
                <div class="slider-releases">
                    <div class="slider-releases-line">
                        <div class="div-favorite">
                            <div class="releases-ddt">
                                <div class="releases-ddt-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                                    <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M35.5 20H20.5V35H15.5V20H0.5V15H15.5V0H20.5V15H35.5V20Z" fill="#F0F0F0" />
                                    </svg>
                                </div>
                            </div>
                            <p class="favorite-text">ДДТ</p>
                        </div>
                        <div class="div-div-albums">
                            <div class="releases-serega-pirat">
                                <div class="releases-serega-pirat-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                                    <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="favorite-text">Серёга Пират</p>
                        </div>
                        <div class="div-playlist">
                            <div class="releases-lida">
                                <div class="releases-lida-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                                    <svg class="plus-black" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="next_button-releases button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M14.4375 3.0625L26.6875 15.3125H0V19.6875H26.6875L14.4375 31.9375L17.5 35L35 17.5L17.5 0L14.4375 3.0625Z" fill="#F0F0F0" />
                </svg>
            </div>
        </div>
    ...
    <div class="top-lists">
        <div class="container">
            <div class="div-title-playlist-main">
                <p class="playlist-title">Топ-листы</p>
            </div>
            <div class="block-of-playlist">
                <svg class="prev_button-top-lists button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M20.5625 3.0625L8.3125 15.3125H35V19.6875H8.3125L20.5625 31.9375L17.5 35L0 17.5L17.5 0L20.5625 3.0625Z" fill="#F0F0F0" />
                </svg>
                <div class="slider-top-lists">
                    <div class="slider-top-lists-line">
                        <div class="div-favorite">
                            <div class="top-pinkpagejpeg666">
                                <div class="releases-ddt-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                            ...
                            <p class="favorite-text">pinkpagejpeg666</p>
                        </div>
                        <div class="div-div-albums">
                            <div class="top-SasakaBone">
                                <div class="releases-serega-pirat-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                            ...
                            <p class="favorite-text">SasakaBone</p>
                        </div>
                        <div class="div-playlist">
                            <div class="top-nonno">
                                <div class="releases-lida-billet">
                ...
                <svg class="next_button-top-lists button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M14.4375 3.0625L26.6875 15.3125H0V19.6875H26.6875L14.4375 31.9375L17.5 35L35 17.5L17.5 0L14.4375 3.0625Z" fill="#F0F0F0" />
                </svg>
            </div>
        </div>
    ...
    <!-- блок с категориями музыки -->

    <div class="top-lists">
        <div class="container">
            <div class="div-title-playlist-main">
                <p class="playlist-title">Категории музыки</p>
            </div>
            <div class="block-of-playlist">
                <svg class="prev_button-categories button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M20.5625 3.0625L8.3125 15.3125H35V19.6875H8.3125L20.5625 31.9375L17.5 35L0 17.5L17.5 0L20.5625 3.0625Z" fill="#F0F0F0" />
                </svg>
                <div class="slider-categories">
                    <div class="slider-categories-line">
                        <div class="div-favorite">
                            ...
                            <p class="favorite-text">Поп</p>
                        </div>
                        <div class="div-div-albums">
                            <div class="categories-rock">
                                <div class="releases-serega-pirat-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                            ...
                            <p class="favorite-text">Рок</p>
                        </div>
                        <div class="div-playlist">
                            <div class="categories-rap">
                                <div class="releases-lida-billet">
                                    <svg class="play-black" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="svg-hover-green" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                                    </svg>
                ...
                <svg class="next_button-categories button-slider" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="button-slider" d="M14.4375 3.0625L26.6875 15.3125H0V19.6875H26.6875L14.4375 31.9375L17.5 35L35 17.5L17.5 0L14.4375 3.0625Z" fill="#F0F0F0" />
                </svg>
            </div>
        </div>
    ...
    <div class="updates-main">
        <div class="container">
            <h2 class="updates-title">Обновления</h2>
            <div class="div-favorite">
                <div class="updates">
                    <div class="updates-billet">
                        <svg class="play-black play-update" width="28" height="35" viewBox="0 0 28 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path class="svg-hover-purple" d="M5 9.1L18.175 17.5L5 25.9V9.1ZM0 0V35L27.5 17.5" fill="#F0F0F0" />
                        </svg>
                        <a href="" class="listen-text updates-text">Слушать</a>
                    </div>
                </div>
                <p class="favorite-text update-subtitle-text">Новый раздел с жанрами</p>
            </div>
        </div>
    </div>
                ...
                <form class="auth_form" action="./php-handler/auth.php" method="post">
                    <div class="email-and-password">
                        <div class="div-input_form-email">
                            <input type="text" class="input_form-email" name="login" placeholder="Имя пользователя" autocomplete="off" required="required" minlength="4">
                        </div>
                    ...
                    <div class="reset-password">
                        <a href="#" class="reset-pass-text">ещё нет аккаунта? зарегистрироваться</a>
                    </div>
            ...
            <div class="form-content">
                ...
                <form class="reg_form" action="./php-handler/reg.php" method="post">
                    <div class="email-and-password">
                        ...
                        <div class="div-input_form-email">
                            <input type="email" class="input_form-email" name="email" placeholder="Почта" autocomplete="off" required="required">
                        </div>
                        <div class="div-input_form-password">
                            <input type="password" class="input_form-email" name="password" placeholder="Пароль" autocomplete="off" required="required" minlength="8">
                        </div>
                    ...
                    <div class="reset-password">
                        <a href="#" class="reset-pass-text div-entry-form-reg">уже есть аккаунт? авторизироваться</a>
                    </div>
                    <div class="another-entrance">
                        <svg width="178" height="1" viewBox="0 0 178 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="0.5" x2="178" y2="0.5" stroke="#454340" stroke-opacity="0.2" />
    ...
    <!-- ниже в будущем должен быть проигрыватель, но это вместе с php -->
    ...
    <script src="./js/slider-releases.js"></script>
    <script src="./js/slider-top-lists.js"></script>
    <script src="./js/slider-categories.js"></script>
